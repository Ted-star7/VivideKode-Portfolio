      ...
      <div class="container page-hero__inner">
        <div ref="heroText">
          ...
          <h1 class="heading-xl" style="color: #fff">
            ...
            <em style="color: var(--gold); font-style: normal"
              >Modern Business</em
            >
          </h1>
          <p
            ...
            "
          >
            From pixel-perfect interfaces to production-grade AI pipelines — we
            cover the full stack of modern digital transformation.
          </p>
          <RouterLink
            to="/book"
            class="btn-gold btn btn-lg"
        ...
        <div class="services-detail-grid" ref="servicesGrid">
          ...
          >
            ...
            <div class="svc-detail-card__tags">
              <span class="vk-badge" v-for="t in svc.tags" :key="t">{{
                t
              }}</span>
            </div>
    ...
    <section class="section section-alt" aria-labelledby="stack-heading">
      <div class="container">
        <div class="section-header" ref="stackHeader">
          ...
          <h2 class="heading-lg" id="stack-heading">
            Tools &amp; Technologies
          </h2>
          <p class="body-lg section-sub">
            We work with the latest, most reliable technologies across the full
            development lifecycle.
          </p>
        </div>
        <div class="stack-grid" ref="stackGrid">
          <div
            class="stack-cat vk-card"
            v-for="cat in techCats"
            :key="cat.name"
          >
            <div class="stack-cat__icon" aria-hidden="true">{{ cat.icon }}</div>
            <h3 class="stack-cat__name">{{ cat.name }}</h3>
            <div class="stack-cat__pills">
              <span class="vk-badge" v-for="t in cat.techs" :key="t">{{
                t
              }}</span>
            </div>
          </div>
      ...
      <div class="container">
        <div class="why-layout">
          <div ref="whyLeft">
            ...
            <h2 class="heading-lg" id="why-heading" style="color: #fff">
              What Sets VividKode<br />Apart
            </h2>
            <p
              class="body-md"
              style="
              ...
              "
            >
              We don't just deliver code — we deliver outcomes. Our integrated
              team thinks commercially as well as technically, ensuring every
              solution drives real business value.
            </p>
      ...
      <div class="container cta-strip__inner">
        ...
        >
          <RouterLink to="/book" class="btn-gold btn btn-lg"
            >Book Free Consultation →</RouterLink
          >
          <RouterLink to="/contact" class="btn-outline-white btn"
            >Talk to Our Team</RouterLink
          >
        </div>
      </div>
    </section>
...
useSeo({
  ...
  description:
    "VividKode Creations offers website development, data science, AI solutions, data engineering, custom software, and API development for ambitious businesses.",
  canonical: "/services",
});
...
const services = [
  ...
  {
    icon: "🗄️",
    title: "Data Modeling & Engineering",
    category: "Data",
    iconBg: "rgba(27,58,92,0.08)",
    iconBorder: "rgba(27,58,92,0.15)",
...
const techCats = [
  {
    icon: "🎨",
    name: "Frontend",
    techs: ["Vue 3", "React", "Next.js", "Nuxt", "TypeScript", "Tailwind CSS"],
  },
...

  {
    icon: "🗄️",
    name: "Databases",
    techs: ["PostgreSQL", "MongoDB", "Redis", "Snowflake", "BigQuery", "MySQL"],
  },
...

  {
    icon: "📊",
    name: "Data Stack",
    techs: ["Apache Spark", "Airflow", "dbt", "Kafka", "Tableau", "Power BI"],
  },
];
...
const whyPoints = [
  {
    ...
    desc: "We start with your business goals and work backwards to the right technical solution.",
  },
  {
    icon: "🔬",
    title: "Full-Stack Expertise",
    desc: "One team covers frontend, backend, data, and AI — no coordination gaps between vendors.",
  },
  {
    icon: "📡",
    title: "Africa-Native Insight",
    desc: "We understand local infrastructure, payment systems, and connectivity realities.",
  },
  {
    icon: "🔒",
    title: "Security by Default",
    desc: "Security is engineered into every layer — not bolted on at the end.",
  },
];
...
onMounted(() => {
  ...
  staggerReveal(stackGrid.value ? [...stackGrid.value.children] : [], {
    y: 40,
    stagger: 0.09,
  });
...
.svc-detail-card:hover .svc-detail-card__accent {
  opacity: 1;
}
...
@media (max-width: 380px) {
  ...
  .svc-detail-card__tags .vk-badge {
    font-size: 0.7rem;
  }
