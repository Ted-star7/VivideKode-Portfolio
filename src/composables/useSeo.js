...
export function useSeo({ title, description, canonical, image } = {}) {
  ...
  const fullTitle = title ? `${title} | ${siteName}` : `${siteName} — Intelligent Digital Solutions`

  // Title
  document.title = fullTitle

  setMeta('name',     'description', description || 'VividKode Creations builds world-class websites, AI solutions, data pipelines, and custom software for ambitious businesses across Africa.')
