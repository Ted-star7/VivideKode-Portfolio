<template>
  <div class="site">
    ...
    <header
      class="navbar"
      :class="{ 'navbar--scrolled': scrolled, 'navbar--solid': solidPages }"
    >
      <div class="navbar__inner container">
        ...
        <RouterLink
          to="/"
          class="navbar__logo"
          aria-label="VividKode Creations — Home"
        >
        ...
        <div class="navbar__actions">
          <RouterLink to="/book" class="btn-navy btn btn-sm"
      ...
      <Transition name="mobile-drawer">
        ...
        >
          <RouterLink
            ...
            >{{ l.label }}</RouterLink
          >
          <RouterLink to="/book" class="mobile-link mobile-link--cta"
      ...
      <div class="footer__inner container">
        ...
        <div class="footer__grid">
          ...
          <div class="footer__brand">
            <RouterLink
              to="/"
              class="footer__logo"
              aria-label="VividKode Creations"
            >
              <svg
            ...
            <p class="footer__tagline">
              Building intelligent digital solutions for ambitious businesses
              across Africa and beyond.
            </p>
            <address class="footer__contact" style="font-style: normal">
              <a href="mailto:vividkode@gmail.com" class="footer__contact-link"
                >vividkode@gmail.com</a
              >
              <a href="tel:+254705171490" class="footer__contact-link"
                >+254 705 171 490</a
              >
            ...
            <div class="footer__col" v-for="col in footerCols" :key="col.title">
              ...
              <ul class="footer__col-list" role="list">
                <li v-for="item in col.items" :key="item.label">
                  ...
                  >
                  <span v-else class="footer__col-link no-link">{{
                    item.label
                  }}</span>
                </li>
              </ul>
        ...
        <div class="footer__bottom">
          <p class="footer__copy">
            © {{ year }} VividKode Creations. All rights reserved. Crafted with
            purpose in Nairobi, Kenya.
          </p>
    ...
    <div class="chat-widget" role="complementary" aria-label="Live chat">
        ...
        >
          <div class="chat__head">
            ...
            <div class="chat__agent">
              <span id="chat-heading" class="chat__agent-name"
                >VividKode Support</span
              >
              <span class="chat__agent-status" aria-live="polite">
                <span class="online-dot" aria-hidden="true" />Online · replies
                instantly
              </span>
            </div>
            <button
      ...
      <div class="chat__fab-wrap">
        <button
          class="chat__fab"
          @click="chat.toggle()"
          :aria-label="chat.open ? 'Close chat' : 'Open live chat'"
        >
...
.nav-link.gold-underline::after {
  bottom: -2px;
}

/* Transparent navbar — white text on hero */
.navbar:not(.navbar--scrolled):not(.navbar--solid) .logo-mark {
  color: #fff;
}
.navbar:not(.navbar--scrolled):not(.navbar--solid) .logo-brand {
  color: #fff;
}
.navbar:not(.navbar--scrolled):not(.navbar--solid) .nav-link {
  color: rgba(255, 255, 255, 0.88);
}
.navbar:not(.navbar--scrolled):not(.navbar--solid) .nav-link:hover {
  color: #fff;
  background: rgba(255, 255, 255, 0.1);
}
.navbar:not(.navbar--scrolled):not(.navbar--solid) .nav-link.active {
...
.navbar:not(.navbar--scrolled):not(.navbar--solid) .hamburger span {
  background: #fff;
}
.navbar:not(.navbar--scrolled):not(.navbar--solid) .hamburger:hover {
...
.footer__col-link.no-link {
  cursor: default;
}
.footer__col-link.no-link:hover {
  color: rgba(255, 255, 255, 0.65);
}
.footer__divider {
  background: rgba(255, 255, 255, 0.1);
...
.chat__fab:hover {
  transform: scale(1.1);
  box-shadow:
    0 12px 38px rgba(27, 58, 92, 0.48),
